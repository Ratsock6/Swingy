...
public class Hero extends Entity {
    ...
    public Hero(String name, EClass eClass, int level, int hitPoints, int attack, int defense, int psychicAttack, int psychicDefense) {
        super(name, hitPoints ,level, hitPoints, attack, defense, psychicAttack, psychicDefense);
        this.eClass = eClass;
